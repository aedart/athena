 ...
 * ```
 *
 * @param {AbstractOrConcreteConstructor<any>} [baseClass] Defaults to an anonymous class when none given
 *
 * @return {Mixer<T>}
 */
export function mix<T extends AbstractOrConcreteConstructor<any>>(baseClass: T = class {} as T): MixerContract<T> {
